...
export declare const ProformaDataModel: {
    getAll(): Promise<ProformaData[]>;
    getByPFMNo(pfmNo: string): Promise<ProformaData[]>;
};
//# sourceMappingURL=m_VW_proformaData.d.ts.map