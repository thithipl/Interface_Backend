...
import { InvoiceHdrModel, ParsedInvoice, ShippingModel } from './Detail_invoice/m_invoice_Hdr';
 ...
 * 
 */
export function createParsedInvoice(rawData: any[] | null, rawItemData: any[] | null): ParsedInvoice {
    ...
    const convertedHeaders: InvoiceHdrModel[] = rawData.map((rawHeader: any) => {


        const singleShipping: ShippingModel[] = rawHeader ? [{
